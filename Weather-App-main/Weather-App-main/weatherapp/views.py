...
def home(request):
    ...
    url = f'https://api.openweathermap.org/data/2.5/weather?q={city}&appid=f6397b442b1cc3404cecfea8f90c4ba3'
    PARAMS = {'units':'metric'}

    API_KEY =  'AIzaSyAfzOGIKCBSj9IMT2qplT6o_iSg1MlRFoQ'

    SEARCH_ENGINE_ID = '7039bb48218d24b2b'
